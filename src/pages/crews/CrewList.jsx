        ...
        onConfirm: async () => {
          ...
          if (!gamesSnapshot.empty) {
            ...
            gamesSnapshot.forEach((gameDoc) => {
              ...
              gameUpdates.push(setDoc(gameSubcolRef, gameSubcolData))
            })
          ...
          const gameCount = gamesSnapshot?.size || 0
          ...
          let successMessage =
            gameCount > 0
              ...
              : DOMPurify.sanitize(t(`${viewDictionary}.approveSuccessMessage`))
