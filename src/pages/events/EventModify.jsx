    ...
    const fetchEventData = async () => {
      try {
        ...
        if (eventDoc.exists()) {
          ...
          // Convertir timestamp a formato de fecha y hora para los inputs
          let startDate = ''
          let startTime = ''
          let endDate = ''
          let endTime = ''
          ...
          if (data.startDateTime) {
            const startDateObj = data.startDateTime.toDate()
            startDate = startDateObj.toISOString().split('T')[0]
            startTime = startDateObj.toTimeString().substring(0, 5)
          }

          if (data.endDateTime) {
            const endDateObj = data.endDateTime.toDate()
