...
function Footer() {
  return (
    <footer className="w-full h-[211px] bg-[#D9D9D9] text-black flex flex-col items-center relative">
      <p className="absolute text-center t20sb top-10">
        Carretera del Reguers, km 1, Roquetes
        <br />
        43520 Tarragona, España <br /> patronatfestesroquetes@gmail.com
      </p>
      <div className="absolute bottom-0 flex justify-between w-full direction-row">
