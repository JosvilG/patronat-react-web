...
function Footer() {
  return (
    <footer className="w-full h-[211px]   backdrop-blur-lg backdrop-saturate-[180%] bg-[rgba(255,255,255,0.75)] max-sm:h-64 max-sm:mb-0 text-black flex flex-col items-center relative">
      <p className="absolute text-center t16r sm:t20sb top-10 max-sm:top-6">
      ...
      <div className="absolute bottom-0 flex justify-between w-full px-4 direction-row max-sm:bottom-6">
        <p className="text-black t12b bottom-4 left-4">
        ...
        <div className="text-end">
          ...
          <p className="text-black sm:t14b t12b bottom-4 left-4">
