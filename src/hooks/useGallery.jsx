...
/**
 * Custom hook to manage gallery images
 *
 * This hook handles fetching, filtering, and navigation of gallery images
 * from Firebase storage, providing a clean interface for displaying images
 * in a gallery component.
 *
 * @returns {Object} Gallery state and control functions
 */
const useGallery = () => {
  ...
  useEffect(() => {
    ...
    const fetchImages = async () => {
      try {
        ...
        // Limit to the 10 most recent images
